...
#define STRING_CONFIG_H_AUTHOR "(FirewinX, BIQU B1 BLTouch)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 81.62, 78.97, 401.00, 142.41 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 12, -16, -3.7 }
