...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_GREEN      27  // User defined GREEN value
      #define LED_USER_PRESET_BLUE       83  // User defined BLUE value
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       1064        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #define E1_HYBRID_THRESHOLD     75
  #define E2_HYBRID_THRESHOLD     75
  #define E3_HYBRID_THRESHOLD     75
  #define E4_HYBRID_THRESHOLD     75
  #define E5_HYBRID_THRESHOLD     75
  #define E6_HYBRID_THRESHOLD     75
  #define E7_HYBRID_THRESHOLD     75
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define Y_STALL_SENSITIVITY  147
